                ...
                <div class="tab-content">
                    <div id="signup">
                        ...
                        <form action="index.php" method="post">
                            ...
                            <div class="field-wrap">
                                <label>
                                    Confirmes ton mot de passe<span class="req">*</span>
                                </label>
                                <input type="password"required autocomplete="off" name="confirmPass"/>
                            </div>
                            <input type="submit" id="submitSignUp" class="button button-block" name="formSignUp" value="Et c'est parti !"/>
                        </form>
                    </div>
                    <div id="login">
                        <h1>De retour ?</h1>
