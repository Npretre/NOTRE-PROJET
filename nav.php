    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
        <div class="menunav">
            <ul class="nav sidebar-nav">
                ...
                <li><a class="ajax-nav" href="parties.php"><i class="fa fa-fw fa-file-o"></i> Mes soirées</a> </li>
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <ul>
                            ...
                            foreach ($playsuser as $playuser) {
                                ?>
                                <li><a class="ajax-nav" href="#"><i class="fa fa-fw fa-home"></i> <?php echo $playuser['name']; ?></a></li>
                                <?php
                            }
                            ?>
                        </ul>
